...
public class RecommendationConverter {
  ...
  public static RecommendationResponseDTO.RecommendationListDTO toRecommendationListDTO(
      List<RecommendationResponseDTO.RecommendationInfoDTO> infoDTOList) {
    ...
    return RecommendationResponseDTO.RecommendationDetailDTO.builder()
        ...
        .sections(
            RecommendationResponseDTO.DetailSectionsDTO.builder()
                .recommendReason(
                    "현재 시장 상황과 사용자의 투자 성향을 종합했을 때 안정적인 현금흐름과 견고한 실적을 바탕으로 장기 보유 관점에서 유리한 종목입니다.")
                .companySummary(
                    "Apple은 글로벌 IT 기업으로 하드웨어, 소프트웨어, 서비스 생태계를 기반으로 높은 수익성과 충성 고객층을 보유하고 있습니다.")
  ...
  // 목록용 임시 리스트
  public static List<RecommendationResponseDTO.RecommendationInfoDTO>
      toRecommendationInfoDTOList() {
    return List.of(
